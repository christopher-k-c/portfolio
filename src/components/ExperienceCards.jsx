        ...
        <BsChevronDoubleDown>
                ...
                {experience[currentIndex].title === 'landing' ? 
                    ...
                    <>
                        ...
                        <div className='absolute flex flex-col p-20 '>
                ...
                <div className='grid grid-cols-1 place-items-center  '>
                    ...
                    className='pt-10 pb-10' key={experience[currentIndex].title}>
                        ...
                        <img className='md:w-60 md:h-60 w-32 h-32 rounded-full bg-gray-900 object-contain object-center p-4 mt-4 flex items-center justify-center border-2 border-indigo-700 ' src={require('./assets/' + experience[currentIndex].image + '.png')} alt="" />
                    </motion.div>
                    ...
                    <div className='pr-10 pl-10'>
                        ...
                        <p className='xl:text-5xl md:text-4xl sm:text-3xl text-2xl pb-2 font-semibold mt-1 text-indigo-600 '>{experience[currentIndex].company}</p>
                        ...
                        {/* LEFT BUTTON */}
                        <div onClick={prevSlide} className='hidden group-hover:block absolute top-[50%] -translate-x-0 translate-y-[-50%] left-5 md:text-7xl text-2xl rounded-full p-2 bg-black/50 text-white cursor-pointer z-20'>
                <BsChevronCompactLeft  ></BsChevronCompactLeft>
            </div>
            {/* RIGHT BUTTON */}
            <div onClick={nextSlide} className='hidden group-hover:block  absolute top-[50%] -translate-x-0 translate-y-[-50%] right-5 md:text-7xl text-2xl rounded-full p-2 bg-black/50 text-white cursor-pointer z-20'>
